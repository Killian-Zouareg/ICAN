...
const highlights = [
  ...
  },
  {
    ...
    icon: '\u{1F3E6}',
    color: '#2ecc71',
    title: 'iBanque \u2014 Syst\u00e8me bancaire',
...
const patches = [
  {
    version: '3.0.0',
    date: '5 avril 2026',
    title: 'iCharacter & iBanque',
    tag: 'major',
    changes: [
      { type: 'new', text: 'Onglet Personnage : fiche compl\u00e8te avec photo, identit\u00e9 (nom, pr\u00e9nom, nationalit\u00e9, sexe, lieu/date de naissance)' },
      { type: 'new', text: '5 comp\u00e9tences : Force, D\u00e9fense, Endurance, Intellect, Charisme (0-100)' },
      ...
      { type: 'new', text: 'Onglet Banque : compte en dollars ($) par profil avec solde affich\u00e9 en grand' },
      ...
      { type: 'new', text: 'Liens Personnage et Banque ajout\u00e9s dans la sidebar et le menu mobile' },
    ],
  },
  {
    version: '2.16.0',
